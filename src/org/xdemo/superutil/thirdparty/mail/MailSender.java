...
public class MailSender {
	...
	public static void main(String[] args) throws GeneralSecurityException, UnsupportedEncodingException {
        ...
        mailInfo.setUserName("LB先生"); // 实际发送者  
        mailInfo.setPassword("666woaini");// 您的邮箱密码  
        mailInfo.setFromAddress("1973840428@qq.com"); // 设置发送人邮箱地址  
        mailInfo.setToAddress("18156224265@163.com"); // 设置接受者邮箱地址,多个收件人逗号隔开  
